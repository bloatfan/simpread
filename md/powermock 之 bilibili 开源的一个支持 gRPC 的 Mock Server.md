> 本文由 [简悦 SimpRead](http://ksria.com/simpread/) 转码， 原文地址 [zhuanlan.zhihu.com](https://zhuanlan.zhihu.com/p/390660950)
...
因为，如果希望通过脚本生成 mock 数据，要将 `powermock` 替换为 `powermock-v8` 命令才可执行`javascript` 脚本。
